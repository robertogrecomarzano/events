...
<table
	...
	<tr>
		...
		<td><label class="block"><a class="text-primary" href="{$row.zoom_link}" target="_blank">{$row.zoom_link}</a></label><label class="block">ID: {$row.zoom_id}</label><label class="block">PWD: {$row.zoom_pwd}</label>
		</td>
