...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = [])
    {
        ...
        $errstr = '';
        if ($streamok) {
            // $socket_context = stream_context_create($options); // Riga sostituita con la seguente per abilitare l'invio tramite ssl
    ...
    {
        return $this->sendCommand('RCPT TO', 'RCPT TO:<' . $address . '>', [
            250,
            251
        ]);
    }
    ...
    {
        return $this->sendCommand('VRFY', "VRFY $name", [
            250,
            251
        ]);
    }
