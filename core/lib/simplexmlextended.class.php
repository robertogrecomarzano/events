...
/**
 * Classe pee gestire l'xml con valori speciali ecc ...
 * @author Roberto
 *
 */
class SimpleXMLExtended extends SimpleXMLElement
{
    ...
    public function addCDataChild($nodeName, $value, $nameSpace = null)
    {
        ...
        return $node->addCData(utf8_decode($value));
    }
     ...
     * @return $this
     */
    public function addAttribute($string, $value = null, $nameSpace = null)
    {
     ...
     *
     * @param SimpleXmlElement $replaceElmt
     *            passed by reference
