			...
			<div class="col-sm-12 col-md-12">
				<div class="logo-title-container logo-title-container">
					...
					<form method="post" role='form' class="col-lg-6 col-md-offset-3">
						...
						<h1>{form_lang value='PASSWORD_RECOVERY_TITLE'}</h1>
						<div class="panel">
							<blockquote>{form_lang value='PASSWORD_RECOVERY_HEADER_TEXT'}</blockquote>
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">@</span>{form_tbox iname='email'
							size=30 max=45 tabindex='11' placeholder="{form_lang
							value='EMAIL'}" type='email' required="email"
							oninvalid="this.setCustomValidity('{form_lang
							value='EMAIL_REQUIRED'}')"}
						</div>
						<div class="form-group">{$captcha}</div>
						<div class='btn-group'>
							<input type='button' value="{form_lang value='RECOVERY'}"
