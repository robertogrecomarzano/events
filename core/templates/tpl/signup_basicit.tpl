...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">{form_select iname='user_group' first=true tabindex='4' src=["ente_pubblico"=>"Ente pubblico","universita"=>"Università / ente di ricerca", "impresa"=>"Impresa","other"=>"Altro"]}</div>
</div>
