...
class Minify_CSS_UriRewriter
{
     ...
     *            The directory of the current CSS file.
     *            
     * @param string $docRoot
     *            The document root of the web site in which
     *            the CSS file resides (default = $_SERVER['DOCUMENT_ROOT']).
     *            
     * @param array $symlinks
     *            (default = array()) If the CSS file is stored in
     ...
     *            file relative URI
     *            
     * @param string $realCurrentDir
     *            realpath of the current file's directory.
     *            
     * @param string $realDocRoot
     *            realpath of the site document root.
     *            
     * @param array $symlinks
     *            (default = array()) If the file is stored in
     *            a symlink-ed directory, provide an array of link paths to
     ...
     * source (within the document root) E.g.
     * '/var/www/symlink' => '/var/realpath'
     *
     * @var array
     */
