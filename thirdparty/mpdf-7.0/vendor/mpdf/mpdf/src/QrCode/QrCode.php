...
class QrCode
{
    ...
    // numero de version maximal autorisé
    private $type = 'bin';
    ...
    // lilmite de nombre de bit maximal pour les datas
    private $max_data_word = 0;

    // lilmite de nombre de mot maximal pour les datas
    private $max_word = 0;

    // lilmite de nombre de mot maximal en global
    private $ec = 0;
     ...
     *            message a encoder
     * @param string $level
     *            niveau de correction d'erreur (ECC) : L, M, Q, H
     */
     ...
     *            couleur du background (R,V,B)
     * @param array $color
     *            couleur des cases et du border (R,V,B)
     *            
     * @return boolean true;
     */
